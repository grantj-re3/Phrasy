...
class Config
  ...
  def user_config
    ...
    @help[:text] = <<-EOF.gsub(/^ {6}/, '')
      ...
      =========================================================
      P H R A S Y - G U E S S   W O R L D   B I R D   N A M E S
      =========================================================
      Config file at #{ConfigFilepath}

      The game of Phrasy is a word-guessing game which is almost identical
      to the game of hangman. In each game you are trying to guess the
      common name of a (world) bird. E.g. LONG BILLED CORELLA.
      ...
      - If an exact match is present in the phrase, the matching letters or
        ...
        * For example if the secret name was "LONG BILLED CORELLA" and you
          entered "e", an "E" whould be shown in positions 10 and 16.
        * If you entered "ella", then "ELLA" would be shown at the end of
          the phrase.
        * If you entered "led corella", then "LED CORELLA" would be shown
          at the end of the phrase. 
        * If you entered "lo" then no extra information would be displayed
          because that *sequence* is not present (even though "L" and "O"
          are present).
